...
/* Remove Streamlit's default block padding */
.block-container {
...
hr { border: none; border-top: 1px solid #e5e0d8; margin: 0.75rem 0; }
</style>
...
# Build image as inline base64 so it lives inside the same HTML block as title
if img_bytes is not None:
    ...
    img_html = f'<img class="game-img" src="data:image/jpeg;base64,{img_b64}" />'
else:
...
# Title + image in ONE markdown call — prevents any Streamlit gap
st.markdown(f"""<div style="margin:0;padding:0;"><div class="game-title"><span style="color:#FF0000">E</span><span style="color:#FF7700">m</span><span style="color:#FFD700">o</span><span style="color:#00AA00">t</span><span style="color:#0000FF">i</span><span style="color:#4B0082">o</span><span style="color:#8B00FF">n</span>&nbsp;<span style="color:#FF0000">M</span><span style="color:#FF7700">a</span><span style="color:#FFD700">t</span><span style="color:#00AA00">c</span><span style="color:#0000FF">h</span><span style="color:#1a1a2e">!</span></div>{img_html}{try_again_html}</div>""", unsafe_allow_html=True)
