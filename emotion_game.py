...
/* Tight spacing — kill gaps between Streamlit elements */
...
hr { border: none; border-top: 1px solid #e5e0d8; margin: 0.3rem 0; }
</style>
...
# Title + image in columns so title centers over image
img_col, pad_col = st.columns([3, 1])
with img_col:
    st.markdown("""
