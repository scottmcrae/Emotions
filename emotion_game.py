...
# ── Emotion definitions ───────────────────────────────────────────────────────
EMOTIONS = [
    {"label": "Anger",     "image": f"{GITHUB_RAW}/anger1.jpg"},
    {"label": "Contempt",  "image": f"{GITHUB_RAW}/contempt1.jpg"},
    {"label": "Disgust",   "image": f"{GITHUB_RAW}/disgust1.jpg"},
    {"label": "Enjoyment", "image": f"{GITHUB_RAW}/enjoyment1.jpg"},
    {"label": "Fear",      "image": f"{GITHUB_RAW}/fear1.jpg"},
    {"label": "Sadness",   "image": f"{GITHUB_RAW}/sadness1.jpg"},
    {"label": "Surprise",  "image": f"{GITHUB_RAW}/surprise1.jpg"},
]
